...
export default function PreviewPage() {
  ...
  useEffect(() => {
    // Lê diretamente do localStorage — funciona mesmo em nova aba
    function loadFromStorage() {
      try {
        ...
        const current: LandingPageConfig | null = state.currentLP || null
        const found = (current?.id === id ? current : pages.find((l) => l.id === id)) || null
    ...
    if (!loadFromStorage()) {
      // Store pode não ter hidratado ainda — tenta por 3s
      let tries = 0
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="text-gray-500 text-sm">Carregando preview...</p>
        </div>
      </div>
    )
  }
  ...
  if (!lp) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <p className="text-gray-400">Landing page não encontrada.</p>
      </div>
    )
  }
      ...
      <div style={{ fontFamily: fontStack }} className="bg-white min-h-screen">
        ...
        <nav className="sticky top-0 z-50 bg-white/95 backdrop-blur-md border-b border-gray-100 px-6 py-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-bold text-gray-900 text-lg">{p.agencyName || 'Luz Smart Site'}</span>
            </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                <div>
                  ...
                  <div className="flex gap-3 flex-wrap">
                    <a href="#contato" className="px-8 py-4 font-bold text-gray-900 text-base shadow-xl hover:opacity-90 transition-all"
                      style={{ background: `linear-gradient(135deg, ${primaryColor}, ${accentColor})`, borderRadius: btnRadius }}>
                      {ctaPrimary}
                    </a>
                    <a href={waLink} target="_blank" rel="noopener noreferrer"
                      className="px-8 py-4 font-bold text-white text-base bg-green-600 hover:bg-green-500 transition-all"
                ...
                <div className="bg-white p-7 shadow-2xl" style={{ borderRadius: '20px' }}>
                  ...
                  <div className="space-y-3">
                    ...
                    <button className="w-full py-4 font-bold text-gray-900 text-sm shadow-lg hover:opacity-90 transition-all"
                      style={{ background: `linear-gradient(135deg, ${primaryColor}, ${accentColor})`, borderRadius: btnRadius }}>
            ...
            <div className="max-w-6xl mx-auto px-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {[
                  ...
                  <div key={i} className="bg-white p-5 text-center shadow-sm border border-gray-100 hover:shadow-md transition-all" style={{ borderRadius: '16px' }}>
        ...
        {enabledSections.find((s: any) => s.type === 'gallery') && p.images.length > 1 && (
          <section className="py-16 bg-white">
            <div className="max-w-6xl mx-auto px-6">
              <h2 className="text-3xl font-black text-gray-900 text-center mb-4">Galeria de fotos</h2>
              <p className="text-gray-500 text-center mb-10">Conheça cada detalhe deste imóvel</p>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {p.images.slice(0, 8).map((img: string, i: number) => (
                  <div key={i} className={`overflow-hidden cursor-pointer ${i === 0 ? 'col-span-2 row-span-2' : ''}`}
                    style={{ borderRadius: '16px', aspectRatio: i === 0 ? '4/3' : '4/3' }}>
            ...
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="max-w-lg mx-auto bg-white border-2 rounded-3xl shadow-xl overflow-hidden" style={{ borderColor: `${primaryColor}30` }}>
                ...
                <div className="px-8 pb-8 pt-4 space-y-3">
                  <a href="#contato"
                    className="flex items-center justify-center gap-2 w-full py-4 font-bold text-white text-base shadow-lg hover:opacity-90 transition-all"
                    style={{ background: primaryColor, borderRadius: btnRadius }}>
                    {ctaPrimary}
                  </a>
                  <a href={waLink} target="_blank" rel="noopener noreferrer"
                    className="flex items-center justify-center gap-2 w-full py-3.5 font-semibold text-gray-700 text-sm bg-gray-100 hover:bg-gray-200 transition-all"
                    style={{ borderRadius: btnRadius }}>
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-4xl mx-auto px-6">
              ...
              <div className="bg-white p-8 shadow-sm border border-gray-100" style={{ borderRadius: '20px' }}>
                ...
                {p.features.length > 0 && (
                  <div>
                    <h4 className="font-bold text-gray-900 mb-4">Características do imóvel</h4>
          ...
          ((p.availableItems && p.availableItems.length > 0) || (p.unavailableItems && p.unavailableItems.length > 0)) && (
            <section className="py-16 bg-white">
              <div className="max-w-5xl mx-auto px-6">
                <h2 className="text-3xl font-black text-gray-900 text-center mb-4">Itens do imóvel</h2>
                <p className="text-gray-500 text-center mb-10">Veja tudo que este imóvel oferece</p>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {p.availableItems && p.availableItems.length > 0 && (
                    <div className="bg-gray-50 p-6 border border-gray-100" style={{ borderRadius: '20px' }}>
                      <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2">
                        <span className="w-6 h-6 rounded-full bg-green-100 flex items-center justify-center text-green-600 text-sm font-black flex-shrink-0">✓</span>
                        Itens disponíveis
                      </h3>
                  ...
                  {p.unavailableItems && p.unavailableItems.length > 0 && (
                    <div className="bg-gray-50 p-6 border border-gray-100" style={{ borderRadius: '20px' }}>
                      <h3 className="font-bold text-gray-400 mb-4 flex items-center gap-2">
                        <span className="w-6 h-6 rounded-full bg-gray-200 flex items-center justify-center text-gray-400 text-sm font-black flex-shrink-0">✕</span>
                        Itens indisponíveis
                      </h3>
                      <div className="space-y-2.5">
        ...
        {enabledSections.find((s: any) => s.type === 'highlights') && p.highlights.length > 0 && (
          <section className="py-16 bg-white">
            <div className="max-w-6xl mx-auto px-6">
              <h2 className="text-3xl font-black text-gray-900 text-center mb-4">Diferenciais</h2>
              <p className="text-gray-500 text-center mb-10">O que torna este imóvel especial</p>
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                {p.highlights.map((h: string) => {
                  const emoji = Object.entries(PROPERTY_ICONS).find(([k]) => h.toLowerCase().includes(k))?.[1] || '✨'
                  return (
                    <div key={h} className="text-center p-6 border border-gray-100 hover:border-gray-200 hover:shadow-md transition-all" style={{ borderRadius: '16px' }}>
          ...
          <section className="py-16" style={{ background: `linear-gradient(135deg, ${primaryColor}18, ${accentColor}10)` }}>
            <div className="max-w-3xl mx-auto px-6 text-center">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <a href="#contato" className="px-8 py-4 font-bold text-gray-900 hover:opacity-90 transition-all"
                  style={{ background: `linear-gradient(135deg, ${primaryColor}, ${accentColor})`, borderRadius: btnRadius }}>
                  Agendar visita agora
                </a>
                <a href={waLink} target="_blank" rel="noopener noreferrer"
                  className="px-8 py-4 font-bold text-white bg-green-600 hover:bg-green-500 transition-all"
                  style={{ borderRadius: btnRadius }}>
                  WhatsApp agora
                </a>
              </div>
          ...
          <section className="py-16 bg-gray-50">
            <div className="max-w-xl mx-auto px-6 text-center">
              ...
              <div className="flex gap-3 justify-center flex-wrap">
                <a href={`tel:${p.phone}`} className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-200 text-gray-700 font-medium text-sm hover:shadow-md transition-all" style={{ borderRadius: btnRadius }}>
                  <Phone className="w-4 h-4" /> {p.phone}
                </a>
                <a href={`mailto:${p.email}`} className="flex items-center gap-2 px-5 py-3 bg-white border border-gray-200 text-gray-700 font-medium text-sm hover:shadow-md transition-all" style={{ borderRadius: btnRadius }}>
                  <Mail className="w-4 h-4" /> E-mail
                </a>
                <a href={waLink} target="_blank" rel="noopener noreferrer"
                  className="flex items-center gap-2 px-5 py-3 bg-green-600 text-white font-medium text-sm hover:bg-green-500 transition-all" style={{ borderRadius: btnRadius }}>
            ...
            <div className="max-w-xl mx-auto px-6">
              ...
              <div className="bg-gray-50 p-8 border border-gray-100" style={{ borderRadius: '20px' }}>
                <div className="space-y-4">
                  <input className="w-full px-4 py-3.5 bg-white border border-gray-200 text-gray-800 text-sm focus:outline-none placeholder-gray-400 focus:border-gray-400" style={{ borderRadius: btnRadius }} placeholder="Nome completo" />
                  <input className="w-full px-4 py-3.5 bg-white border border-gray-200 text-gray-800 text-sm focus:outline-none placeholder-gray-400 focus:border-gray-400" style={{ borderRadius: btnRadius }} placeholder="Telefone / WhatsApp" />
                  <input className="w-full px-4 py-3.5 bg-white border border-gray-200 text-gray-800 text-sm focus:outline-none placeholder-gray-400 focus:border-gray-400" style={{ borderRadius: btnRadius }} placeholder="E-mail" />
                  <textarea className="w-full px-4 py-3.5 bg-white border border-gray-200 text-gray-800 text-sm focus:outline-none placeholder-gray-400 resize-none focus:border-gray-400" style={{ borderRadius: btnRadius }} rows={3}
                    placeholder="Mensagem (opcional)" defaultValue={`Olá! Tenho interesse no imóvel: ${p.title}. Poderia me enviar mais informações?`} />
                  <button className="w-full py-4 font-bold text-gray-900 text-base shadow-lg hover:opacity-90 transition-all"
                    style={{ background: `linear-gradient(135deg, ${primaryColor}, ${accentColor})`, borderRadius: btnRadius }}>
            ...
            <div className="max-w-6xl mx-auto px-6">
              <div className="flex flex-col md:flex-row items-center justify-between gap-6 mb-8">
                ...
                <div className="flex items-center gap-2 flex-wrap justify-center md:justify-end">
                  ...
                  <a href={waLink} target="_blank" rel="noopener noreferrer"
                    className="flex items-center gap-1.5 px-3 py-2 bg-green-700 rounded-xl text-white text-xs font-medium hover:bg-green-600 transition-all">
                    <Send className="w-4 h-4" /> WhatsApp
                  </a>
                </div>
              </div>
              <div className="border-t border-gray-800 pt-6 flex flex-col md:flex-row items-center justify-between gap-2">
                <p className="text-gray-600 text-xs">© {new Date().getFullYear()} {p.agencyName}. Todos os direitos reservados. · <a href="#" className="hover:text-gray-400">Política de privacidade</a></p>
